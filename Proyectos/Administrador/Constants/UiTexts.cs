...
public static class UiTexts
{
    ...
    public const string LoginAyuda = "Ingresa con tu cuenta. El administrador necesita la llave USB en este computador. El usuario super ingresa sin llave.";
    ...
    public const string InstalacionesSub = "Instale la aplicación en un PDA o prepare una memoria USB como llave de administrador.";
    ...
    public const string LlaveAdminTarjeta = "Registrar llave de administrador";
    public const string LlaveAdminTarjetaAyuda = "Prepare una memoria USB NTFS, asóciela a un administrador y úsela para ingresar a este computador.";
    public const string LlaveAdminTitulo = "Registrar llave de administrador";
    public const string LlaveAdminSub = "Seleccione el administrador, conecte una USB externa y genere la llave. Los datos de la memoria se eliminan al prepararla.";
    public const string LlaveAdminUsuario = "Usuario administrador";
    public const string LlaveAdminUsuarioRequerido = "Seleccione el usuario administrador al que se asociará la llave.";
    public const string LlaveAdminUsb = "Memoria USB";
    public const string LlaveAdminGenerar = "Generar llave";
    public const string LlaveAdminConfirmarBorrado = "Entiendo que los datos de esta memoria USB serán eliminados.";
    public const string LlaveAdminConfirmarReemplazo = "Invalidar la llave actual y generar una nueva.";
    public const string LlaveAdminSinAdministradores = "No hay usuarios administrador activos para asociar una llave.";
    public const string LlaveAdminSinUsb = "Conecte una memoria USB externa. No se utilizan discos internos.";
    public const string LoginUsb = "Llave USB";
    public const string LoginUsbVarias = "Hay más de una memoria USB. Seleccione la que corresponde a su llave.";
    public const string LoginUsbNinguna = "No hay una memoria USB conectada. El administrador debe conectar su llave.";
    ...
    public const string Jugado = "JUGADO";
    public const string NumeroTirilla = "NUMERO";
    public const string ValorTirilla = "VALOR";
    public const string TotalTirilla = "TOTAL";
    public const string TotalApostado = "TOTAL APOSTADO";
    public const string LoteriasTirilla = "LOTERIAS";
    public const string ColumnaLoteriaTirilla = "LOTERIA";
    public const string QrDelTicket = "Código QR del ticket";
    ...
    public const string VerFotoDelTicket = "Ver la fotografía del ticket en tamaño completo";
    public const string DatosDeLaApuesta = "Datos de la apuesta";
    public const string DatosDeLaApuestaSub = "Recibo de venta, número jugado, lotería y fecha del sorteo en que ganó el ticket.";
    public const string ReciboDeVentaCaso = "Recibo de venta";
    public const string NumeroApostado = "Número apostado";
    public const string NumeroGanadorColumna = "Número ganador";
    public const string ResultadoColumna = "Resultado";
    public const string ResultadoGano = "Ganó";
    public const string ResultadoNoGano = "No ganó";
    public const string ResultadoSinPublicar = "Sin publicar";
    public const string FechaEnQueGano = "Fecha en que ganó";
    public const string TotalApostadoCaso = "Total apostado";
    public const string SinDatosApuesta = "Todavía no hay datos de la apuesta para este ticket.";
    public const string EntregaDelPremio = "Entrega del premio registrada por el observador";
    public const string EntregaDelPremioSub = "Información que el observador solicitó al ganador y evidencias fotográficas de la entrega.";
    ...
    public const string NombreVendedorEntrega = "Nombre del vendedor";
    ...
    public const string FechaEntrega = "Fecha de entrega";
    public const string EvidenciasEntrega = "Evidencias fotográficas de la entrega";
    public const string SinEntregaRegistrada = "El observador todavía no ha registrado la entrega del premio.";
    public const string SinEvidencias = "No hay fotografías registradas para esta entrega.";
    public const string FechaValidacion = "Fecha de validación";
    public const string FechaAsignacion = "Fecha de asignación";
